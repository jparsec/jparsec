...
* If you are on Java 21+, prefer using Google Mug [Dot Parse](https://github.com/google/mug/blob/master/dot-parse/README.md) - a re-imagined parser combinator library:
  * The API uses static type to completely eliminate infinite loops or accidental left recursions caused by zero-consumption parser - traditionally very painful to debug.
