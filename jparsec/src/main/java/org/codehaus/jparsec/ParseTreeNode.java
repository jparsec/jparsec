...
public interface ParseTreeNode {
   ...
   * Add sub nodes.
   */
  void addChildren(List<ParseTreeNode> children);

  /**
   * On a successful match, this is the start index. Default is null, which means no match.
   */
  ...
  /**
   * On a successful match, this is the end index. Default is null, which means no match.
   */
